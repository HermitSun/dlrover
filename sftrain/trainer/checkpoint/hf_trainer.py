...
from .deepspeed import AsyncCheckpointAgent
...
class FlashCkptTrainer(Trainer):
    ...
    by the step int the file `sftrain_latest.txt` in the `OUTPUT_DIR` of
    `TrainingArguments`.
    """
    ...
    def get_last_checkpoint(self):
        ...
        persistence may not finish. The step in the `sftrain_latest.txt` is
    ...
    def _get_last_checkpoint_step(self):
        tracer_file = os.path.join(self.args.output_dir, "sftrain_latest.txt")
