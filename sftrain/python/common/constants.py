class BasicClass(object):
    LOG_LEVEL_ENV = "SFTRAIN_LOG_LEVEL"
...
class NodeEnv(object):
    ...
    SFTRAIN_MASTER_ADDR = "SFTRAIN_MASTER_ADDR"
...
class ConfigPath(object):
    ENV_PARAL_CONFIG = "SFTRAIN_PARAL_CONFIG_PATH"
    PARAL_CONFIG = "/tmp/sftrain/auto_paral_config.json"
    ENV_RUNTIME_METRICS = "RUNTIME_METRICS_PATH"
    RUNTIME_METRICS = "/tmp/sftrain/runtime_metrics.json"
    NETWORK_CHECK_DATA_DIR = "/tmp/sftrain/network_check/"


class CheckpointConstant(object):
    TRACER_FILE_NAME = "sftrain_latest.txt"
