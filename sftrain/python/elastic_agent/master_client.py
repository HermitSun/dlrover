...
from sftrain.proto import elastic_training_pb2, elastic_training_pb2_grpc
from sftrain.python.common import env_utils, grpc
from sftrain.python.common.constants import NetworkFailureReason, NodeEnv
from sftrain.python.common.log import default_logger as logger
from sftrain.python.common.singleton import Singleton
from sftrain.python.diagnosis.common.diagnosis_data import (
    ChipMetrics,
    CudaLog,
    TrainingLog,
)
...
def build_master_client(master_addr=None, timeout=5):
    ...
    if master_addr is None:
        master_addr = os.getenv(NodeEnv.SFTRAIN_MASTER_ADDR, "")
