...
import sftrain.python.util.file_util as fu
from sftrain.python.common import env_utils
from sftrain.python.common.constants import (
    CheckpointConstant,
    NodeEnv,
    TrainingExceptionLevel,
)
from sftrain.python.common.error import ProcessError
from sftrain.python.common.log import default_logger as logger
from sftrain.python.common.multi_process import (
    SharedDict,
    SharedLock,
    SharedMemory,
    SharedQueue,
)
from sftrain.python.common.serialize import ClassMeta
from sftrain.python.elastic_agent.master_client import MasterClient

SFTRAIN_CKPT_CONFIG_KEY = "_SFTRAIN_CKPT_CONFIG"
...
class SharedMemoryHandler(object):
    ...
    def save_state_dict(self, state_dict):
        ...
        ckpt_conf: CheckpointConfig = meta_dict[SFTRAIN_CKPT_CONFIG_KEY]
    ...
    def load_state_dict(self):
        ...
        config = meta_dict.get(SFTRAIN_CKPT_CONFIG_KEY, default_config)
    ...
    def no_checkpoint_state(self):
        ...
        """
        meta_dict = self.metadata.get()
        config: CheckpointConfig = meta_dict.get(SFTRAIN_CKPT_CONFIG_KEY, None)
...
class AsyncCheckpointSaver(metaclass=ABCMeta):
    ...
    _STAGE_DIR = "._sftrain_ckpt_stage"
